...
namespace addrWin0302.UI
{
    partial class ViewForm : MaterialForm
    {
        ...
        {
            string[] data = { "1", "홍길동", "010-1234-1111", "조선한양", "hong@naver.com" };
            listView.Items.Add(new ListViewItem(data));

            for (int i = 0; i < 50; i++)
            {
                listView.Items.Add(new ListViewItem(new string[]
                    {(i+2).ToString(), "홍길동", "010-1234-1111", "조선한양", "hong@naver.com"}));
            }
        ...
        private void initGridView()
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                gridView.Rows.Add(new string[] { (i + 2).ToString(), "홍길동", "010-1234-1111", "조선한양", "hong@naver.com" });
            }
        ...
        private void viewExit_Click_Click(object sender, EventArgs e)
        {
            Close();
        }
