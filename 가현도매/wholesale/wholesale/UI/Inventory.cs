    ...
    partial class Inventory : Form
    {
        ...
        private void update_b_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DB_Wholesale.DB_update(textBox_item.Text, textBox_id.Text, textBox_color.Text, textBox_size.Text, textBox_stock.Text);
        ...
        private void insertB_Click(object sender, EventArgs e) //추가버튼을 누르면 텍스트박스에 있는 내용들을 가지고 추가
        {
            try
            {
                InventoryData inventoryDatas = new InventoryData(textBox_item.Text, textBox_id.Text, textBox_color.Text, textBox_size.Text, textBox_stock.Text);
